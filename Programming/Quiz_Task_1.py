"""
Mini Quiz app
You are required to build a flow/navigation of a mini 
quiz app where users can answer multiple-choice questions, 
receive immediate feedback on their answers, and see t
heir final scores at the end of the quiz.
